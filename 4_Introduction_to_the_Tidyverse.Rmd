...
This symbol "%>%" is called a "pipe" and you read it like as "and then":

dataset %>% ### Get the variable called dataset "and then",
  filter(column_2 == x) %>% ### Filter column_2 to only get the values from that column that are equal to x, "and then",
  arrange(desc(column_3)) ### Arrange the dataset in descending order, based on values from column 3
